...
const alertVariants = cva(
  "flex items-stretch w-full gap-2 group-[.toaster]:w-(--width)",
  {
    variants: {
      ...
      size: {
        lg: "p-4 gap-3 text-base [&>[data-slot=alert-icon]>svg]:size-5 *:data-slot=alert-icon:mt-0 *:data-slot=alert-close:mt-0.5 *:data-slot=alert-close:-me-0.5",
        md: "p-3.5 py-3 gap-2.5 text-[13px] [&>[data-slot=alert-icon]>svg]:size-4.5 *:data-slot=alert-icon:mt-0 *:data-slot=alert-close:-me-0.5",
        sm: "px-3 py-2.5 gap-2 text-xs [&>[data-slot=alert-icon]>svg]:size-3 *:data-alert-icon:mt-0.5 *:data-slot=alert-close:-me-0.5 [&>[data-slot=alert-close]>svg]:size-3.5!",
      },
    },
    compoundVariants: [
      {

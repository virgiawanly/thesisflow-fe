  ...
  const headerButton = () => {
    return (
      <Button
        variant="ghost"
        className={cn(
          "text-secondary-foreground font-normal -ms-2 px-2 py-1.5 h-7 my-1 min-h-fit hover:bg-muted data-[state=open]:bg-muted hover:text-foreground data-[state=open]:text-foreground overflow-x-hidden",
          className
        )}
      ...
      >
        {icon && icon}
        <div className="flex-1 text-wrap text-left">{title}</div>
